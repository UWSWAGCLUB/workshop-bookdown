...
2. For each $\boldsymbol{\theta}_i$, compute $\omega_i = f(\boldsymbol{\theta})/g(\boldsymbol{\theta})$.
...
## form importance sampling weights on log-scale 
w <- 
## exponentiate weights from log-scale
w <- 
## standardize weights
q <- 
...
inds <-
## extract posterior sample from initial sample
post_alpha <-
post_beta <- 
