...
- **Strongly Ignorable Treatment Assignment (SITA).** The treatment indicator ($T$) and the response variables ($Y_{1i}$, $Y_{0i}$) are independent given the set of covariates ($X$); $(Y_{1}, Y_{0}) \perp T\mid X$.
